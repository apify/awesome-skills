...
2. Fetch the input schema: `apify actors info "johnvc/ai-overview-rewrite-queue" --input --user-agent apify-awesome-skills/apify-search-console-ai-overview 2>/dev/null`
